...
@Setter
@Node("I")
public class IdentityClazz implements Serializable {
    @Id
    private UUID id;
    private String name;
    ...
    public IdentityClazz() {
        this.properties = "";
        this.labels = new HashSet<>();
        this.entityClass = "";
    }

    public IdentityClazz(UUID id, String name, ClazzType type, Map<String, String> properties, String entityClass) {
    ...
    public IdentityClazz(UUID id, String name, ClazzType type, String entityClass) {
        this.id = id;
        this.name = name;
        this.type = type;
        this.properties = "";
    ...
    public IdentityClazz(String name) {
        this.name = name;
        this.labels = new HashSet<>();
    }
    ...
    public IdentityClazz addProperty(String key, String value) {
    ...
    public boolean equals(Object o) {
        if (!(o instanceof IdentityClazz n)) {
            return false;
        }
